...
const STPM_Com_port_t STPM_com_port[4] ={  
  {
  USART2,    			//USART used by device 1
  METER_CS1_GPIO_Port,  //CS used by device 1
  METER_CS1_Pin,
  METER_SYN1_GPIO_Port, //SYN used by device 1
  METER_SYN1_Pin,
  METER_EN1_GPIO_Port,     //EN used by device 1
  METER_EN1_Pin
  },
  {
  USART2,     //USART used by device 2
  GPIOD,      //CS used by device 2
  SCS_B_Pin,
  GPIOD,      //SYN used by device 2
  SCS_B_Pin,
  GPIOD,      //EN used by device 2
  EN_B_Pin
  },
  {
  USART2,     //USART used by device 3
  GPIOD,      //CS used by device 3
  SCS_C_Pin,
  GPIOD,      //SYN used by device 3
  SCS_C_Pin,
  GPIOD,      //EN used by device 3
  EN_C_Pin
  },
  {
  USART2,     //USART used by device 4
  GPIOD,      //CS used by device 4
  SCS_C_Pin,
  GPIOD,      //SYN used by device 4
  SCS_C_Pin,
  GPIOD,      //EN used by device 4
  EN_C_Pin
  }
};
#endif
