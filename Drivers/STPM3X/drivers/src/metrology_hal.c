...
void Metro_HAL_init_device(METRO_NB_Device_t in_Metro_Device_Id)
{
  ...
  if(in_Metro_Device_Id >= EXT1) 
  {
    ...
    Metro_HAL_WaitMicroSecond(1000); 
    Metro_HAL_CSS_EXT_Device(in_Metro_Device_Id,CS_PIN_INACTIVE);
...
#ifdef ENABLE_UART_PIN_SWAP
  huart[in_Metro_Device_Id].AdvancedInit.AdvFeatureInit = UART_ADVFEATURE_SWAP_INIT;
  huart[in_Metro_Device_Id].AdvancedInit.Swap = UART_ADVFEATURE_SWAP_ENABLE;
#else
